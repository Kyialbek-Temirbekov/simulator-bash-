...
NAME=$(get_yaml_value "module.name" "config/step_count_sensor.yaml")
BASE_TOPIC=$(get_yaml_value "module.topic" "config/step_count_sensor.yaml")
TOPIC=$(echo "$BASE_TOPIC" | sed "s|+|$CLIENT_ID|")
FREQUENCY=$(get_yaml_value "module.frequency" "config/step_count_sensor.yaml")
MIN=$(get_yaml_value "this.min" "config/step_count_sensor.yaml")
MAX=$(get_yaml_value "this.max" "config/step_count_sensor.yaml")
PRECISION=$(get_yaml_value "this.precision" "config/step_count_sensor.yaml")
