...
NAME=$(get_yaml_value "module.name" "config/saturation_sensor.yaml")
BASE_TOPIC=$(get_yaml_value "module.topic" "config/saturation_sensor.yaml")
TOPIC=$(echo "$BASE_TOPIC" | sed "s|+|$CLIENT_ID|")
FREQUENCY=$(get_yaml_value "module.frequency" "config/saturation_sensor.yaml")
MIN=$(get_yaml_value "this.min" "config/saturation_sensor.yaml")
MAX=$(get_yaml_value "this.max" "config/saturation_sensor.yaml")
PRECISION=$(get_yaml_value "this.precision" "config/saturation_sensor.yaml")
