...
NAME=$(get_yaml_value "module.name" "config/air_quality_sensor.yaml")
BASE_TOPIC=$(get_yaml_value "module.topic" "config/air_quality_sensor.yaml")
TOPIC=$(echo "$BASE_TOPIC" | sed "s|+|$CLIENT_ID|")
FREQUENCY=$(get_yaml_value "module.frequency" "config/air_quality_sensor.yaml")
MIN=$(get_yaml_value "this.min" "config/air_quality_sensor.yaml")
MAX=$(get_yaml_value "this.max" "config/air_quality_sensor.yaml")
PRECISION=$(get_yaml_value "this.precision" "config/air_quality_sensor.yaml")
